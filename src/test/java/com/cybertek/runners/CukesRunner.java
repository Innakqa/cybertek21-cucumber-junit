...
@CucumberOptions(
        ...
        dryRun = true, //true - allows to run the feature files to get the snippets //true checks if there are any unimplemented steps, and will have them in the bottom window
